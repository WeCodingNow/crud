...
function helpers.prepare_simple_functions(router)
    ...
    local _, err = router:eval([[
        ...
        return_true = function(space_name) -- luacheck: ignore
            sleep_for(sleep_time)
            return true
        end

        return_err = function(space_name) -- luacheck: ignore
            sleep_for(sleep_time)
            return nil, error_table
        end

        pairs_ok = function(space_name) -- luacheck: ignore
            sleep_for(sleep_time)
            return pairs({})
        end
